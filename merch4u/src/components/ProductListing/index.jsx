                    ...
                    <div className='rightContent w-[80%] py-3!'>
                        <div className='bg-[#f1f1f1] p-2! w-full mb-4! rounded-md flex items-center justify-between'>
                            <div className='col1 flex items-center ItemViewActions'>
                                <Button className={`w-[40px]! h-[40px]! min-w-[40px]! rounded-full! text-black! ${itemView === 'list' && 'active' }`} onClick={() => SetItemView('list')}>
                                    <LuMenu className='text-[rgba(0,0,0,0.7)]'/>
                                </Button>

                                <Button className={`w-[40px]! h-[40px]! min-w-[40px]! rounded-full! text-black! ${itemView === 'grid' && 'active' }`} onClick={() => SetItemView('grid')}>
                                    <IoGridSharp className='text-[rgba(0,0,0,0.7)]'/>
                                </Button>
                                

                                <span className='text-[14px] font-medium pl-3! text-[rgbs(0,0,0,0.7)]'>There are 27 products</span>
                            </div>



                            <div className='col2 ml-auto! flex items-center justify-end'>
                                <span className='text-[14px] font-medium pl-3! pr-3! text-[rgba(0,0,0,0.7)]'>Sort by</span>
                                ...
                                <Button
                                    ...
                                    onClick={handleClick}
                                    className='bg-white! text-[12px]! text-black! capitalize! border! border-black!'
                                >
                                ...
                                >
                                    <MenuItem onClick={handleClose} className='text-[13px]! text-black! capitalize!'>Sales, highest to lowest</MenuItem>
