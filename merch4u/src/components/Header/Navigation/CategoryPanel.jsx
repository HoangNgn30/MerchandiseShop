        ...
        <Box sx={{ width: 250 }} role="presentation" className='categoryPanel'>
            ...
            <div className='scroll'>
                <ul className='w-full'>
                    <li className='list-none flex items-center relative flex-col'>
                        ...
                        <ul className='submenu w-full pl-3!'>
                            <li className='list-none relative'>
                                <Link to='/' className='w-full'>
                                    <Button className='w-full text-left! justify-start! px-3! text-[rgba(0,0,0,0.8)]! '>Tops</Button>
                                </Link>
...

                                {
                                    ...
                                    <ul className='inner_submenu w-full pl-3!'>
                                        <li className='list-none relative mb-1'>
                                            <Link to='/' className='link w-full text-left! justify-start! px-3! transition text-[14px]'>Hoodies</Link>
                                        </li>
                                        <li className='list-none relative mb-1'>
                                            <Link to='/' className='link w-full text-left! justify-start! px-3! transition text-[14px]'>Tee</Link>
                                        </li>
                                    </ul>
                                    )
                                }
                    ...
                    <li className='list-none flex items-center relative flex-col'>
                        <Link to='/' className='w-full'>
                            <Button className='w-full text-left! justify-start! px-3! text-[rgba(0,0,0,0.8)]! '>Collectables</Button>
                        </Link>
                        ...
                        <ul className='submenu w-full pl-3!'>
                            <li className='list-none relative'>
                                <Link to='/' className='w-full'>
                                    <Button className='w-full text-left! justify-start! px-3! text-[rgba(0,0,0,0.8)]! '>Photocard</Button>
                                </Link>
...

                                {
                                    ...
                                    <ul className='inner_submenu w-full pl-3!'>
                                        <li className='list-none relative mb-1'>
                                            <Link to='/' className='link w-full text-left! justify-start! px-3! transition text-[14px]'>Postcard</Link>
                                        </li>
                                        <li className='list-none relative mb-1'>
                                            <Link to='/' className='link w-full text-left! justify-start! px-3! transition text-[14px]'>Photo</Link>
                                        </li>
                                        <li className='list-none relative mb-1'>
                                            <Link to='/' className='link w-full text-left! justify-start! px-3! transition text-[14px]'>Trading Card</Link>
                                        </li>
                                    </ul>
                                    )
                                }
